...
This project is indexed by GitNexus as **godot-mcp-terravolt** (3011 symbols, 5156 relationships,
146 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate
safely.
