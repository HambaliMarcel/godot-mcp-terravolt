...
TerraVolt **godot-mcp-terravolt** uses **GitNexus** for codebase intelligence when JS/TS (and analyzed) sources land here.
...
This project is indexed by GitNexus as **godot-mcp-terravolt** (1971 symbols, 3667 relationships, 128 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
