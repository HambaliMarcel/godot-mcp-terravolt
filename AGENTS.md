...
This project is indexed by GitNexus as **godot-mcp-terravolt** (2722 symbols, 4463 relationships,
128 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate
safely.
