...
2. Structural — `docs/architecture/overview.md`, **`docs/references/reference-repos-map.md`**,
   `artifacts/js-graphs/*.json`, GitNexus contexts.
3. SRS & build order — **`docs/srs/README.md`**, **`docs/srs/00-fundamentals-contract.md`**, phased
   specs in `docs/srs/`.
