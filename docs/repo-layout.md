...
Single source for **where things live**. The root **[README](../README.md)** stays a short
onboarding page; pointers lead here.
...
| **[`docs/`](./README.md)**                            | Architecture, SRS, reference map, contributing, roadmap [`tasklist/`](tasklist/).                                                                     |
