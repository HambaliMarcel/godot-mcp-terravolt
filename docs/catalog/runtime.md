...
Phase 3 work-unit #7 — 19 playmode methods (`catalog_version` **0.9.0**+, registry band **0.12.0**
when shipped with later categories).
...
Game process: `packages/godot-mcp-addon/autoloads/runtime_bridge.gd` (TCP **6506**,
`terravolt_mcp/runtime/port` or `TERRAVOLT_RUNTIME_PORT`)
